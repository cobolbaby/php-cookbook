...
=================
   ...
   * [目录](#目录)
      ...
      * [奇淫巧技](#奇淫巧技)
         * [1) 非阻塞请求](#1-非阻塞请求)
         * [2) Promises/A ](#2-promisesa)
         * [3) Redis管道](#3-redis管道)
         * [4) MQ协议](#4-mq协议)
         * [5) MySQL批量插入](#5-mysql批量插入)
         * [6) 守护进程](#6-守护进程)
         * [7) 多线程](#7-多线程)
         * [8) 内存使用优化](#8-内存使用优化)
         * [9) 插件机制实现](#9-插件机制实现)
         * [10) 日志管理](#10-日志管理)
         * [11) 排序算法](#11-排序算法)
         * [12) Composer](#12-composer)
         * [13) 锁机制](#13-锁机制)
         * [14) MySQL字段类型](#14-mysql字段类型)
         * [15) Cache-Aside](#15-cache-aside)
         ...
         * [20) 文件流式上传](#20-文件流式上传)
         * [21) apiDoc](#21-apidoc)
         * [22) MySQL读写分离](#22-mysql读写分离)
         * [23) 软件安防](#23-软件安防)
         * [24) 迭代器](#24-迭代器)
         * [25) 并发下的事务安全](#25-并发下的事务安全)
         * [26) 分片上传超大文件](#26-分片上传超大文件)
         * [27) Sphinx vs Elasticsearch](#27-sphinx-vs-elasticsearch)
         * [28) Redis Cluster](#28-redis-cluster)
         * [29) MySQL Proxy](#29-mysql-proxy)
         * [30) 数据库分库分表](#30-数据库分库分表)
         * [31) MySQL严格模式](#31-mysql严格模式)
         * [32) PDO](#32-pdo)
         * [33) DocumentFragment(文档碎片)的应用](#33-documentfragment文档碎片的应用)
         * [34) Bloom filter](#34-bloom-filter)
         * [35) mysql_unbuffered_query 与 mysql_query 的区别](#35-mysql_unbuffered_query-与-mysql_query-的区别)
         * [36) MySQL查询大小写不敏感](#36-mysql查询大小写不敏感)
         * [37) 检测敏感词](#37-检测敏感词)
         * [38) PHPOffice](#38-phpoffice)
         * [39) 页面静态化](#39-页面静态化)
         * [40) 城市站点](#40-城市站点)
      * [参考](#参考)
